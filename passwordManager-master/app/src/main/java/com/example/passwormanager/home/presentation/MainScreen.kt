...
import com.example.passwormanager.home.util.InfoBox
import com.example.passwormanager.home.util.InfoCard
import com.example.passwormanager.home.util.CommonTextField
import com.example.passwormanager.home.util.PasswordInfoBox
        ...
        if (editModelSheetbtn) {
            ModalBottomSheet(onDismissRequest = { editModelSheetbtn = false }) {
                ...
                Column(
                    ...
                    InfoBox("Account Name",decryptedAccountName)
                    InfoBox("Username/Email",decryptedUserName)

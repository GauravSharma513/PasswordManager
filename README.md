...
1. **Clone the Repository:**
   ...
   - In the "URL" field, paste the repository URL: https://github.com/GauravSharma513/PasswordManager
...
2. **Set Up Development Environment:**
   - Ensure you have the necessary environment set up for Android development:
     ...
     - Android SDK with API level 32 (Android 11) or higher.
     - Android Build Tools version 30.0.3 or higher.
     - Kotlin plugin installed and updated to the latest version.

3. **Open Project in Android Studio:**
   - Once the cloning process is complete, the project will open automatically. If not, then open the project by selecting File > Open and navigating to the cloned project directory.
...
2. **Build and Run:**
   - Click on the green play button (Run) in the Android Studio toolbar, or select Run > Run 'app' from the menu.
